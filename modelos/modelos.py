...
class Archivo(db.Model):
    ...
    solicitudes = relationship(
        'Solicitud', backref='archivo', cascade="all,delete")
...
class Solicitud(db.Model):
    ...
    registro_conversion = relationship(
        'RegistroConversion', uselist=False, backref='solicitud', cascade="all,delete")
...
class RegistroConversion(db.Model):
    ...
    id_usuario = db.Column(db.Integer, ForeignKey(
        'usuarios.id'), nullable=False)
    id_solicitud = db.Column(db.Integer, ForeignKey(
