#!/bin/bash
export DATABASE_URL=postgresql://example:example@35.222.189.6:5432/example
export CELERY_RESULT_BACKEND=redis://104.197.227.209:6379/0
export PUERTO_SMTP=587
export CELERY_BROKER_URL=redis://104.197.227.209:6379/0
