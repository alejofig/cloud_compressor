#!/bin/bash
export DATABASE_URL=postgresql://example:example@35.232.107.59:5432/example
export CELERY_RESULT_BACKEND=redis://35.193.183.231:6379/0
export PUERTO_SMTP=587
export CELERY_BROKER_URL=redis://35.193.183.231:6379/0
