#!/bin/bash
export DATABASE_URL=postgresql://example:example@34.29.53.187:5432/example
export CELERY_RESULT_BACKEND=redis://34.132.139.73:6379/0
export PUERTO_SMTP=587
export CELERY_BROKER_URL=redis://34.132.139.73:6379/0
